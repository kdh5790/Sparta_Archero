...
public enum Skill
{
    ...
    HealthBoost,            //O  4.HP부스트 : 최대 체력 20%를 증가시키며 증가한 만큼 체력 회복, 증가하는 체력은 기본 최대 체력(현재 200) 기준
    Rage,                   //X  5.분노 : 잃은 체력 1% 당 데미지가 1.2% 증가한다.
    ...
    MultiShot,              //X  9.멀티샷 : 모든 공격을 한번 더 발사하지만 공격속도 15% 하락, 최종공격력 10% 하락
    FrontArrowPlus,         //O 10.전방 화살 +1 : 전방으로 발사하는 화살 추가, 탄환당 공격력 25% 하락
